...
* :material-chart-line: **NWP model data** — Numerical Weather Prediction model data in a GRIdded Binary (GRIB2) format for specific parameters and domains (down to hourly values), or at specific points
* :material-radar: **Radar data** — Unprocessed radar data for Canadian radars, such as:
    * Digital outputs of radar echoes or precipitation in ASCII format
    * Full doppler volume scans data in ODIM_H5 format
* :material-map: **Meteorological maps**
* :material-file-document-outline: **Text bulletins**
* :material-server: **MSC open data services** — Most of the data available on the free [MSC Datamart](../msc-datamart/index.md) and [MSC GeoMet](../msc-geomet/index.md) services

### Radar data pricing

Details regarding **radar data pricing** are as follows. Please note that these rates are indicative only and may change.
...
| 6–10 radars (any whole region) | \$1,800/month |
| 11+ radars | \$2,000/month |
...
| 6–10 radars (any whole region) | \$700/month |
| 11+ radars | \$800/month |
...
See also the [FAQ](../faq/index.md).

### NWP data and other data

Starting price regarding push feed for **NWP data in GRIB format, or any other data**:

| Volume | Price |
|---|---|
| Up to 1 GB/day | \$500/month + \$500 setup fee |
| Each additional GB/day | +\$500/month |
| Changes to existing data feeds | \$200 per change |
