...
* Freezing rain accumulation</br>
       &emsp;&emsp;[HRDPS data documentation](../msc-data/nwp_hrdps/readme_hrdps.md)</br>
...
###### &emsp;[GDPS data documentation](../msc-data/nwp_gdps/readme_gdps.md)
* Visibility through liquid fog
* Visibility through ice fog
* Gust
...
###### &emsp;[RPDS data documentation](../msc-data/nwp_rdps/readme_rdps.md)
* Presence of blowing snow
...
###### &emsp;[Satellite data documentation](../msc-data/obs_satellite/readme_satellite.md)
