...
This data is available on the [MSC Datamart](../../msc-datamart/index.md) data server and the [MSC GeoMet](../../msc-geomet/index.md) web services:

* [Provincial and territory observation summaries in XML format, available on the MSC Datamart](readme_obs_insitu_xmldatamart.md) 
* [Surface Weather Observations in Markup Language SWOB Met-ML, available on the MSC Datamart](readme_obs_insitu_swobdatamart.md)
