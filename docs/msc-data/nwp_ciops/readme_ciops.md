...
This data is available on the [MSC Datamart](../../msc-datamart/index.md) data services:

* [Data available via the GeoMet-Weather geospatial web services](readme_ciops-geomet.md)
* [NetCDF data available on the MSC Datamart](readme_ciops-datamart.md)
...
The chronology of changes to the Coastal Ice Ocean Prediction System (CIOPS) is available [here](changelog_ciops.md).
