...
* [XML data available on the MSC Datamart](readme_citypageweather-datamart.md) 
* [Data available via geospatial web services GeoMet-Weather](../../msc-geomet/index.md), notably via the GeoMet-OGC-API [real-time City Page Weather](https://api.weather.gc.ca/collections/citypageweather-realtime?lang=en) experimental collection
