...
The CanSIPS datas are available on GeoMet-Weather via the [Web Map Service (WMS)](../../msc-geomet/wms.md) and [Web Coverage Service (WCS)](../../msc-geomet/wcs.md) standards.
