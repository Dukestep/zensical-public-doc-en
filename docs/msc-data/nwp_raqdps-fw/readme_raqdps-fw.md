...
This data is available from the [MSC GeoMet](../../msc-geomet/index.md) API / web services and the [MSC Datamart](../../msc-datamart/index.md) data server:

* [Data available via the GeoMet-Weather geospatial web services](readme_raqdps-fw-geomet.md)
* [GRIB2 data available on the MSC Datamart](readme_raqdps-fw-datamart.md) 

An [overview and examples to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display the `RAQDPS-FW.EATM_PM2.5-DIFF` layer served by MSC GeoMet:
...
The chronology of changes to operational systems is available [in the changelog](changelog_raqdps-fw.md).
