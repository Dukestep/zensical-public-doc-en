...
* [Data available via the GeoMet-Weather API / geospatial web services](readme_geps-geomet.md)
* [GRIB2 data available on the MSC Datamart](readme_geps-datamart.md) 

An [overview and examples to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display the `GEPS.DIAG.12_PRMM.ERGE10` layer served by MSC GeoMet:
...
The chronology of changes to the Global Ensemble Prediction System (GEPS) is available [here](changelog_geps.md).
