...
* Changes to the forecast model:
    ...
    * The ocean and sea-ice initial conditions come from the [GIOPS v3.0.0](../nwp_giops/changelog_giops.md) analysis.
