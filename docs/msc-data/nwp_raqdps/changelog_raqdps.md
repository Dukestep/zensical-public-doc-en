...
* The RAQDPS is now piloted by a 10km component of the [Global Deterministic Prediction System (GDPS)](../nwp_gdps/readme_gdps.md)
...
* The RAQDPS is now piloted by [RDPS v8.0.0](../nwp_rdps/changelog_rdps.md), rather than RDPS v7.1.0.
