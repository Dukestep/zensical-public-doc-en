...
This data is available on the [MSC Datamart](../../msc-datamart/index.md) data server services as well as [MSC GeoMet](../../msc-geomet/index.md):

* [Data available via the GeoMet-Weather geospatial web services](readme_lightning-geomet.md)
* [GeoTIFF data available on the MSC Datamart](readme_lightning-datamart.md)
