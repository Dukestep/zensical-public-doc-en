...
* [Data available via the GeoMet-Weather geospatial web services](readme_gdps-geomet.md)
* [Data available on the MSC Datamart](readme_gdps-datamart.md)
* [Global Environmental eMuLator (GEML) data available on the MSC Datamart](readme_gdps-geml-datamart.md)
* [Statistically post-processed data on the MSC Datamart](readme_gdps-statpostproc-datamart.md)
* [Experimental weather elements on the grid data available on the MSC testing data repository DD-Alpha](readme_gdps-datamart-alpha.md)
* [Global ice analysis on the MSC Datamart](readme_gdps-ice-anal-datamart.md)

An [overview and examples to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display the `GDPS_15km_PrecipType-Significant1h` layer served by MSC GeoMet:
...
The chronology of changes to the Global Deterministic Prediction System (GDPS) is available [here](changelog_gdps.md).
