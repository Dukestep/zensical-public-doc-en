...
* [Data available from GeoMet-OGC-API / geospatial web services](readme_climateobs-geomet.md)
* [CSV data available on the MSC Datamart](readme_climateobs-datamart.md)
