...
This data is available on the [MSC GeoMet](../../msc-geomet/index.md) web service as well as [MSC Datamart](../../msc-datamart/index.md) data server service:

* [Current data and archives available on the GeoMet-Weather geospatial web services](readme_rdpa-geomet.md)
...
* [Current GRIB2 data available on the MSC Datamart](readme_rdpa-datamart.md) 

An [overview and examples to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display the quantity of precipitation `[mm]` over the past period of 24 hours using a Regional Deterministic Precipitation Analysis (RDPA) WMS layer served by MSC GeoMet:
...
The chronology of changes to the Regional Deterministic Precipitation Analysis (RDPA) is available [here](changelog_rdpa.md).
