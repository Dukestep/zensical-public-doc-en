...
* [RDPS v8.0.0](../nwp_rdps/changelog_rdps.md) now provides the trial field instead of RDPS v7.1.0
...
* [RDPS v7.0.0](../nwp_rdps/changelog_rdps.md) now provides the trial field instead of RDPS v6.0.0.
...
* The trial fields for these precipitaion analyses are generated from the new version of the system implemented on September 18, 2018:
    * CaPA-RDPA now builds its trial fields from [RDPS v6.0.0](../nwp_rdps/changelog_rdps.md)
