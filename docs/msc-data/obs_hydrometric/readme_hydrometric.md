...
The data is available from the [MSC GeoMet](../../msc-geomet/index.md) API / web services and on the [MSC Datamart](../../msc-datamart/index.md) data server:
...
* [Real-time Hydrometric Data in CSV format available on the MSC Datamart](readme_hydrometric-datamart.md) 
