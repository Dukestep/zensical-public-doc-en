...
The weather alerts layer is [available on GeoMet-Weather via the Web Map Service (WMS) standard](../../msc-geomet/index.md).
...
It is possible [filter alerts using CQL2](../../msc-geomet/ogc_api.md#ogc-api-advanced-filtering-with-cql2).
