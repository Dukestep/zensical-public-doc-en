...
* [HRDPS v6.0.0](../nwp_hrdps/changelog_hrdps.md) now provides the trial field instead of HRDPS v5.2.0
...
* [HRDPS v5.1.0](../nwp_hrdps/changelog_hrdps.md) now provides the trial field instead of HRDPS v5.0.0.
...
* The trial fields for these precipitaion analyses are generated from the new version of the system implemented on September 18, 2018:
    * CaPA-HRDPA now builds its trial fields from [HRDPS v5.0.0](../nwp_hrdps/changelog_hrdps.md)
