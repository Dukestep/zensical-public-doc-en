...
This data is available on the [MSC GeoMet](../../msc-geomet/index.md) API and on the [MSC Datamart](../../msc-datamart/index.md) data server:

* [Hurricane response zone and trajectories available on the GeoMet-Weather web services](readme_hurricanes_geomet.md)
* [Trajectories data available on the MSC Datamart](readme_hurricanes-datamart.md)
