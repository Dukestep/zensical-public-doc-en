...
*  The GDSPS v2.1.0 is driven by wind, atmospheric pressure, ice concentration, ice velocities, surface currents, salinity and ocean temperature profiles from the upgraded [Global Deterministic Prediction System (GDPS)](../nwp_gdps/readme_gdps.md) v9.0.0 and [Global Ice Ocean Prediction System (GIOPS)](../nwp_giops/readme_giops.md) v3.5.0
