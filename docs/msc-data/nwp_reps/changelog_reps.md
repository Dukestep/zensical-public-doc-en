...
* Boundary conditions coming from new [Global Ensemble Prediction System (GEPS)](../nwp_geps/readme_geps.md) at 25 km resolution.
* Use of a 10km component of the [Global Deterministic Prediction System (GDPS)](../nwp_gdps/readme_gdps.md), for initial conditions as a replacement of the Regional Deterministic Prediction System (RDPS).
...
* The system is now piloted by GEPS 5.0.0 (see [here](../nwp_geps/changelog_geps.md) for further details), rather than GEPS 4.3.0.
