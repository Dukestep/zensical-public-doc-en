...
These terrestrial data are available on the data server services [MSC Datamart](../../msc-datamart/index.md) and the web services [MSC GeoMet](../../msc-geomet/index.md) respectively :

* [CSV data available on the MSC Datamart](readme_meteocode-datamartcsv.md) 
* [XML data available on the MSC Datamart](readme_meteocode-datamartxml.md) 
