...
This document describes the content of the [meteocode data](readme_meteocode.md) in CSV format.
...
* **ANN** : See the section 'File name nomenclature' in the [CMML documentation](readme_meteocode-datamartxml.md)
