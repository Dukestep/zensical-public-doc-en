...
This data is available from the [MSC GeoMet](../../msc-geomet/index.md) API / web services and on the [MSC Datamart](../../msc-datamart/index.md) data server:

* [Data available on the GeoMet-Climate geospatial web services](readme_dcs-geomet.md)
...
* [NetCDF data available on the MSC Datamart](readme_dcs-datamart.md)

An [overview and examples to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display the [DCS.PR.RCP26.YEAR.2021-2040_PCTL50](https://geo.weather.gc.ca/geomet-climate?service=WMS&version=1.3.0&request=GetCapabilities&layer=DCS.PR.RCP26.YEAR.2021-2040_PCTL50) layer served by MSC GeoMet:
