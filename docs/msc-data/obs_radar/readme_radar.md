...
* [Radar layers available via geospatial web services on GeoMet-Weather](readme_radar_geomet.md):
    * North American radar composite
    * North American radar surface precipitation type
    * North American radar extrapolation
* [GIF radar imagery available on the MSC Datamart](readme_radarimage-datamart.md)
* [Canadian weather radar visibility products](readme_radar-visibility-datamart.md)

An [overview and examples on how to access and use the Meteorological Service of Canada's open data](../../usage/index.md) is available. Example of a web map configured to display weather radar composite and extrapolation Web Map Service (WMS) layers served by MSC GeoMet:
...
The [end-user licence for Environment and Climate Change Canada's data servers](../../licence/index.md) specifies the conditions of use for this data.
