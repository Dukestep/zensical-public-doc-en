...
The weather radar layers are [available on GeoMet-Weather via the Web Map Service (WMS) standard](../../msc-geomet/index.md).
...
The [usage overview page](../../usage/index.md) provides generic information on using these services with desktop software, mobile apps, interactive web maps and direct access. Please refer to the [tutorials and technical documentation on MSC GeoMet geospatial web services](../../msc-geomet/index.md) for detailed information. See also the [main weather radar data page](readme_radar.md) which links to additional information on weather radar.
...
* Legends are available for every WMS style. Details are provided in [the WMS legend technical documentation](../../msc-geomet/wms.md#handling-styles)
