...
* [NetCDF data available on the MSC Datamart](readme_giops-datamart.md) 
...
The chronology of changes to the Global Ice-Ocean Prediction System (GIOPS) is available [here](changelog_giops.md).
