...
These data are generated hourly from the [Regional Deterministic Prediction System](./readme_rdps.md) up to 84 hours and projected on a polar-stereographic grid at 35km resolution.
