...
-   :material-weather-cloudy: **GeoMet-Weather**

    ---

    GeoMet-Weather provides access to the Meteorological Service of Canada (MSC) weather, and environmental data via interoperable web services.

-   :material-api: **GeoMet-OGC-API**

    ---

    GeoMet-OGC-API provides access to the Meteorological Service of Canada (MSC) and Environment and Climate Change Canada (ECCC) data via the emerging Open Geospatial Consortium standards.

-   :material-snowflake: **GeoMet-Climate**

    ---

    GeoMet-Climate provides access to Environment and Climate Change Canada (ECCC) climate data via interoperable web services.
...
-   :material-map-outline: **Web Map Service (WMS)**

    ---

    Web Map Service (WMS) is a standard protocol that allows users to request and receive geospatial map images from a server over the internet.

    [:octicons-arrow-right-24: More info](wms.md)

-   :material-api: **OGC API**

    ---

    OGC API (Open Geospatial Consortium API) is a new set of standardized web APIs (Application Programming Interfaces) that facilitate easy and uniform access to geospatial data and services.

    [:octicons-arrow-right-24: More info](ogc_api.md)

-   :material-grid: **Web Coverage Service (WCS)**

    ---

    Web Coverage Service (WCS) is a standard protocol that enables users to request and retrieve geospatial data in the form of coverages or grids over the internet.

    [:octicons-arrow-right-24: More info](wcs.md)

-   :material-database-search: **SpatioTemporal Asset Catalog (STAC)**

    ---

    SpatioTemporal Asset Catalog (STAC) is an OGC community standard that provides a common structure for describing and cataloging spatiotemporal assets.

    [:octicons-arrow-right-24: More info](stac.md)
