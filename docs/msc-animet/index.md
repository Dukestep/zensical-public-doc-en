...
MSC AniMet provides access to [GeoMet-Weather and GeoMet-Climate](../msc-geomet/index.md) layers.

## Access

[:lucide-layers-plus: Access to MSC AniMet ](https://eccc-msc.github.io/msc-animet/){ .md-button .md-button--primary }
...
``` mermaid
flowchart TD
    A[Add weather and climate layers to the map.] --> B[Customize the content of the map.]
    B --> C[Configure the animation.]
    C --> D[Create and share the map and animation.]
...
<figure markdown="span">
  ...
  <figcaption>Set up common meteorological analysis view with the presets panels</figcaption>
</figure>

#### <span class="badge badge-info">1.2 - Available layers</span>

Users can choose a layer by typing a variable, a system, a level or by browsing though all available layers in the layer tree. Refer to the [list of available datasets](../msc-data/index.md) for additional information on MSC Open Data offerings.
...
!!! tip "User's own vector datasets"
...
![Basemap](https://collaboration.cmc.ec.gc.ca/cmc/cmos/public_doc/msc-animet/Basemap_en.jpg){ align=left }
...
MSC AniMet leverages data from the 24/7 mission critical [MSC GeoMet web services](../msc-geomet/index.md). We encourage users to subscribe to the [GeoMet-Info](https://comm.collab.science.gc.ca/mailman3/postorius/lists/geomet-info/) announcement mailing list to be informed of enhancements and changes to MSC AniMet.
...
!!! example "MSC AniMet source code"
    :lucide-folder-git-2: The MSC AniMet source code is publicly available on GitHub: [https://github.com/ECCC-MSC/msc-animet](https://github.com/ECCC-MSC/msc-animet)
