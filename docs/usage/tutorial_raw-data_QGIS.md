...
It is possible to directly add geospatial files from the [MSC Datamart](../msc-datamart/index.md) in QGIS by dragging and dropping a file into the QGIS map interface:
...
The same approach also works for adding raw data retrieved from the WCS and OGC API - Features web services available on [MSC GeoMet](../msc-geomet/index.md).
