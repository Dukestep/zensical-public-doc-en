...
A sample script using this protocol is made available by Environment and Climate Change Canada. See [Script](#script) section below.

## Description

!!! example "Prerequisite"
    The script uses the [python](https://www.python.org/) language  and must be installed on the system where it will be run.  Moreover, the **python-amqp** library must also be installed.  Please read the documentation specific to your operating system for instructions on installing the software and this library.
