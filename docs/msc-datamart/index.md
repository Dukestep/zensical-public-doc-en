...
!!! info inline end "Retention period"
    A retention period of 30 days is in effect for all datasets.
...
The documentation for this service is found on the [MSC Datamart AMQP documentation](amqp.md).

:material-information-outline: Note:  Users requiring one-time data retrieval may use [wget to download data from the MSC Datamart](readme_wget-datamart.md). Please review the [Service usage policy](../usage-policy/index.md).
...
Access to data via [the AMQP protocol is of course strongly recommended](amqp.md).
...
* Tutorials:
    * Use data in the QGIS desktop software:
        * [Add raw data](../usage/tutorial_raw-data_QGIS.md)
* [End-use licence](../licence/index.md)
* [Service usage policy](../usage-policy/index.md)

## Data formats

Data on the MSC Datamart is available in open formats. It includes:

- [x] [GRIB2](../msc-data/readme_grib.md)
- [x] [NetCDF](https://www.unidata.ucar.edu/software/netcdf/)
- [x] [GeoJSON](https://geojson.org/)
- [x] [Shapefile](https://www.esri.com/library/whitepapers/pdfs/shapefile.pdf)
- [x] CSV
- [x] XML
